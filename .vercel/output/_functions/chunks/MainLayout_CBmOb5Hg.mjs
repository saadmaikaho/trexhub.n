import { c as createComponent, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, m as maybeRenderHead, r as renderComponent, b as addAttribute, d as createAstro, k as defineScriptVars, j as renderSlot, F as Fragment, h as renderHead, i as renderScript } from './astro/server_D9AOt8k0.mjs';
import 'kleur/colors';
...
const Logo = createSvgComponent({"meta":{"src":"/_astro/logo-alt.Bj0kGXFH.svg","width":240,"height":36,"format":"svg"},"attributes":{"width":"240","height":"36","viewBox":"0 0 240 36","fill":"none"},"children":"\n  <path d=\"M18 5.535L35.6 0.35L30.464 18L35.6 35.6L18 30.465L0.35 35.6L5.533 18L0.35 0.35L18 5.535Z\" fill=\"#b9ff66\" />\n  <text x=\"46\" y=\"27\" font-family=\"Arial, Helvetica, sans-serif\" font-size=\"26\" font-weight=\"700\" fill=\"white\" letter-spacing=\"-0.5\">TrexHub</text>\n"});
...
const Instagram = createSvgComponent({"meta":{"src":"/_astro/instagram.DarTZAUQ.svg","width":448,"height":512,"format":"svg"},"attributes":{"viewBox":"0 0 448 512"},"children":"<!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d=\"M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z\" />"});

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const socialLinks = [
    { name: "Facebook", src: Facebook, link: "https://facebook.com" },
    { name: "Instagram", src: Instagram, link: "https://instagram.com" },
    { name: "Linkedin", src: Linkedin, link: "https://linkedin.com" },
    { name: "Twitter", src: Twitter, link: "https://twitter.com" }
  ];
  const marketingServices = [
    { name: "Social Media Marketing", href: "/services/social-media-marketing" },
    { name: "Growth Marketing Services", href: "/services/growth-marketing-lead-generation" },
    { name: "Social Media Advertising", href: "/services/facebook-instagram-ads" },
    { name: "SEO Services", href: "/services/seo" },
    { name: "Digital Marketing Services", href: "/services" },
    { name: "Email Marketing Services", href: "/services/email-whatsapp-marketing" },
    { name: "Ecommerce Marketing", href: "/services" },
    { name: "PPC Management Services", href: "/services/google-ads-ppc" },
    { name: "WhatsApp Marketing", href: "/services/email-whatsapp-marketing" }
  ];
  const agencyServices = [
    { name: "Facebook Advertising Agency", href: "/services/facebook-instagram-ads" },
    { name: "Instagram Ads Agency", href: "/services/facebook-instagram-ads" },
    { name: "Google Ads Agency", href: "/services/google-ads-ppc" },
    { name: "TikTok Ads Agency", href: "/services/social-media-marketing" },
    { name: "Social Media Marketing Agency", href: "/services/social-media-marketing" },
    { name: "PPC Paid Search Agency", href: "/services/google-ads-ppc" },
    { name: "SEO Agency", href: "/services/seo" },
    { name: "Email Marketing Agency", href: "/services/email-whatsapp-marketing" }
  ];
  const company = [
  ...
  return renderTemplate`${maybeRenderHead()}<section class="sm:px-5"> <div class="w-full max-w-[1240px] mx-auto"> <div class="px-[15px] bg-dark text-gray py-[55px] lg:px-[60px] sm:rounded-t-[45px]"> <!-- Top row: logo + social --> <div class="flex flex-col lg:flex-row gap-7 items-center justify-between mb-12"> <a href="/" class="flex items-center gap-3"> ${renderComponent($$result, "Image", $$Image, { "src": Logo, "alt": "TrexHub Logo" })} </a> <ul class="flex gap-5"> ${socialLinks.map((s) => renderTemplate`<li> <a${addAttribute(s.link, "href")} target="_blank" rel="noopener noreferrer"${addAttribute(s.name, "aria-label")}> ${renderComponent($$result, "Image", $$Image, { "src": s.src, "alt": s.name, "class": "w-6 h-6" })} </a> </li>`)} </ul> </div> <!-- Multi-column links --> <div class="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12"> <!-- Marketing Services --> <div> <h4 class="text-white font-medium uppercase tracking-widest text-sm mb-5">Marketing Services</h4> <ul class="flex flex-col gap-3"> ${marketingServices.map((l) => renderTemplate`<li><a${addAttribute(l.href, "href")} class="text-gray-400 hover:text-[#b9ff66] transition-colors text-sm">${l.name}</a></li>`)} </ul> </div> <!-- Agency Services --> <div> <h4 class="text-white font-medium uppercase tracking-widest text-sm mb-5">Agency Services</h4> <ul class="flex flex-col gap-3"> ${agencyServices.map((l) => renderTemplate`<li><a${addAttribute(l.href, "href")} class="text-gray-400 hover:text-[#b9ff66] transition-colors text-sm">${l.name}</a></li>`)} </ul> </div> <!-- Company --> <div> <h4 class="text-white font-medium uppercase tracking-widest text-sm mb-5">Company</h4> <ul class="flex flex-col gap-3"> ${company.map((l) => renderTemplate`<li><a${addAttribute(l.href, "href")} class="text-gray-400 hover:text-[#b9ff66] transition-colors text-sm">${l.name}</a></li>`)} </ul> </div> <!-- Contact --> <div> <h4 class="text-white font-medium uppercase tracking-widest text-sm mb-5">Contact Us</h4> <ul class="flex flex-col gap-3 text-sm text-gray-400"> <li>hello@trexhub.ng</li> <li>+234 8129843426</li> <li>Victoria Island,<br>Lagos, Nigeria</li> </ul> <a href="/#contact" class="mt-6 inline-block px-6 py-3 bg-[#b9ff66] text-black rounded-xl font-medium text-sm hover:bg-white transition-colors">
Book a Free Call
</a> </div> </div> <div class="h-[1px] bg-gray opacity-20 mb-5"></div> <div class="flex flex-col md:flex-row justify-between items-center gap-2 text-sm text-gray-500"> <span>© 2025 TrexHub Digital Marketing Agency. All rights reserved.</span> <span class="flex gap-4"> <a href="/privacy-policy" class="hover:text-[#b9ff66] transition-colors">Privacy Policy</a> <a href="/terms-of-service" class="hover:text-[#b9ff66] transition-colors">Terms of Service</a> </span> </div> </div> </div> </section>`;
}, "/Users/d4ault/Downloads/Positivus-main/src/components/ui/Footer.astro", void 0);

var __freeze$2 = Object.freeze;
var __defProp$2 = Object.defineProperty;
var __template$2 = (cooked, raw) => __freeze$2(__defProp$2(cooked, "raw", { value: __freeze$2(raw || cooked.slice()) }));
var _a$2;
const $$Astro$c = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/Astronav.astro", void 0);

const $$Astro$b = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);

const $$Astro$a = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);

const $$Astro$9 = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);

const $$Astro$8 = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);

const $$Astro$7 = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);

const $$Astro$6 = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);

const $$Astro$5 = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);

var __freeze$1 = Object.freeze;
var __defProp$1 = Object.defineProperty;
var __template$1 = (cooked, raw) => __freeze$1(__defProp$1(cooked, "raw", { value: __freeze$1(cooked.slice()) }));
var _a$1;
const $$Astro$4 = createAstro("https://trexhub.ng");
...
}, "/Users/d4ault/Downloads/Positivus-main/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);

var __freeze = Object.freeze;
var __defProp = Object.defineProperty;
var __template = (cooked, raw) => __freeze(__defProp(cooked, "raw", { value: __freeze(cooked.slice()) }));
var _a;
const $$Astro$3 = createAstro("https://trexhub.ng");
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  const navButton = { href: "/#contact", label: "Book a Free Call" };
...
}, "/Users/d4ault/Downloads/Positivus-main/src/layouts/MainHead.astro", void 0);
...
const $$MainLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-ouamjn2i> ${renderComponent($$result, "MainHead", $$MainHead, { ...props, "data-astro-cid-ouamjn2i": true })}${renderScript($$result, "/Users/d4ault/Downloads/Positivus-main/src/layouts/MainLayout.astro?astro&type=script&index=0&lang.ts")}${maybeRenderHead()}<body class="bg-white font-grotesk" data-astro-cid-ouamjn2i> <main data-astro-cid-ouamjn2i> ${renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-ouamjn2i": true })} ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-ouamjn2i": true })} </main> <!-- WhatsApp Floating Button --> <a href="https://wa.me/2348129843426?text=Hi%20TrexHub%2C%20I%27d%20like%20to%20learn%20more%20about%20your%20digital%20marketing%20services." target="_blank" rel="noopener noreferrer" aria-label="Chat with TrexHub on WhatsApp" class="whatsapp-float" data-astro-cid-ouamjn2i> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="28" height="28" data-astro-cid-ouamjn2i> <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" data-astro-cid-ouamjn2i></path> </svg> <span class="whatsapp-tooltip" data-astro-cid-ouamjn2i>Chat with us</span> </a>  </body> </html>`;
}, "/Users/d4ault/Downloads/Positivus-main/src/layouts/MainLayout.astro", void 0);
